...
last_message_time = None  # Almacena el tiempo en que se mostró el mensaje de bienvenida

# Tiempo mínimo en segundos antes de mostrar el mensaje nuevamente (5 minutos)
...
try:
    while True:
        ...
        for (x, y, w, h) in faces_rects:
            ...
            cv2.putText(frame_resized, detected_name, (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 255), 2)
        ...
        if detected and detected_name != "Usuario Externo":
            if last_detected_name != detected_name:
                ...
                last_message_time = None  # Permitir mostrar el mensaje de bienvenida si es la primera vez
                ...
                # Verificar si han pasado 5 minutos desde el último mensaje
                if last_message_time is None or time.time() - last_message_time >= message_timeout:
                    ...
                    last_message_time = time.time()  # Registrar la hora en que se mostró el mensaje
        ...
        # Si no se detecta a la persona por más de un tiempo, eliminar el mensaje
            ...
            if time.time() - detection_start_time >= detection_lost_time:
                ...
                last_message_time = None  # Reiniciar el tiempo de mensaje
